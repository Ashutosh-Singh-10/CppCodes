...
{   
    ...
    // cout<<a<<"  ";
    for(int i=max((ll)0,start-mxd);i<=max((ll)0,start);i++)
    {
        // cout<<mid<<"  "<<i<<endl;
        ans=(ans+(mid*i))%mod;
        if(b%2==0)
    ...
    if(a%2==0)
    {
        start++;
                ...
                // cout<<"HII"<<start<<"   "<<mxd<<endl;;
                for(int i=start;i<=min(a,start+mxd);i++)
                {
                    // cout<<mid<<"  "<<i<<endl;
                    ans=(ans+(mid*i))%mod;
                    if(b%2==0)
    ...
    {
                for(int i=start+1;i<=min(a,start+mxd);i++)
                {
                    // cout<<mid<<"  "<<i<<endl;
                    ans=(ans+(mid*i))%mod;
                    if(b%2==0)
