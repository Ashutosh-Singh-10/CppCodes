...
{   
    ...
    // cout<<"the size"<<te.size()<<endl;
    if(te.size()<=1)
    {
        cout<<te[0].first<<" "<<te[0].first-1<<endl;
return ;
    }
    if(te[0].first==te[1].second)
    {
        cout<<te[0].first<<" "<<te[1].first-1<<endl;
    }
    else cout<<te[1].first<<" "<<te[0].first-1<<endl;
